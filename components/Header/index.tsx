...
const Header = () => {
  ...
  const [dropdownToggler, setDropdownToggler] = useState(0);
              ...
              {menuData.map((menuItem, key) => (
                <li key={key} className={menuItem.submenu && "group relative"}>
                  {menuItem.submenu ? (
                    <>
                      <button
                        onClick={() => setDropdownToggler(menuItem.id == dropdownToggler ? 0 : menuItem.id)}
                      ...
                      <ul
                        className={`dropdown ${dropdownToggler == menuItem.id ? "flex" : ""}`}
                      >
